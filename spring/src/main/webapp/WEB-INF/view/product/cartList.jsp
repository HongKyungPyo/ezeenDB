...
<script>
	...
	{	alert("")
		...
		var cnt=0; var tatalPrice=0;
		for(var i=0;i<chk.length;i++)
			{	if(chk[i].checked==true)
				{
					cnt++;
					tatalPrice+=Number(hddchk[i].value);
				}
			}
	...
	{
		if(cartQty>1){location.href="goodsCartQtyDown?prodNo"+prodNo+"&prodPrice"+prodPrice;}
		else alert("최소 구매 수량은 1입니다.");
	}
...
<c:forEach items="${list }" var="productCartDTO"  >
	<tr><td>
		...
		<td align="center"><a href="javascript:checkQty('${productCartDTO.cartDTO.cartQty}','${productCartDTO.productDTO.prodNo}','${productCartDTO.productDTO.prodPrice}');">-</a>&nbsp;&nbsp;&nbsp;${productCartDTO.cartDTO.cartQty}
							&nbsp;&nbsp;&nbsp;<a href="cartAdd?prodNo=${productCartDTO.productDTO.prodNo}&cartQty=1&prodPrice=${productCartDTO.productDTO.prodPrice}&catNum=0">+</a></td>
	...
	<tr><td colspan="5" align="right">
		...
		전체 금액 :<span id="tatalPrice">${total } </span><br/>
		</td></tr>
