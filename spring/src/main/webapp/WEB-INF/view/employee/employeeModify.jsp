...
<table border="1" width="500" align="center">
	...
	<tr><td>아이디 </td>
		...
		<tr><td>부서명 </td>
		<td>
			<input type="text" name="empDeptNumber" value="${emp.empNo }">
		</td></tr>
		<tr><td>이메일 </td>
		<td>
		...
		<td>
			<input type="text" name="empPhoneNumber"
				placeholder="010-1234-5678" value="${emp.empPhoneNumber }">
		</td></tr>
		<tr><td>입사일 </td>
		<td>
			<input type="text" name="hireDate"
				placeholder="2000-10-25" value=
				"<fmt:formatDate value='${emp.hireDate }' type='date' pattern='yy/mm/dd'/>">
		</td></tr>
		<tr><td>급여 </td>
		<td>
